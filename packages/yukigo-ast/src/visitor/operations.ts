...
export function OperationTraverser<TBase extends VisitorConstructor<TraverseBase>>(
  Base: TBase,
) {
  abstract class OperationTraverser
    extends Base
    implements OperationVisitor<void>
  {
