...
export function PrimitiveTraverser<TBase extends VisitorConstructor<TraverseBase>>(
  Base: TBase,
) {
  abstract class PrimitiveTraverser
    extends Base
    implements PrimitiveVisitor<void>
  {
