...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "comment", "symbols": [(PreprocessorLexer.has("comment") ? {type: "comment"} : comment)], "postprocess": d => null},
    {"name": "empty_line", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL)], "postprocess": d => null},
    ...
    {"name": "application$ebnf$1$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "lambda_expression$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "lambda_expression$subexpression$2", "symbols": ["_"]},
    {"name": "lambda_expression$subexpression$2", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "data_expression", "symbols": ["constr", "_", (PreprocessorLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "fields_expressions", "_", (PreprocessorLexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess":  
        (d) => d[0] + ` { ` + d[4] + ` }`
        },
    ...
    {"name": "if_expression$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "if_expression$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "if_expression$subexpression$3$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "if_expression$subexpression$4$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "if_expression$subexpression$5$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "letin_expression$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "letin_expression", "symbols": [{"literal":"let"}, "block_start", "letin_expression$ebnf$1", "block_end", {"literal":"in"}, "letin_expression$subexpression$1", "expression"], "postprocess": (d) => `let { ${(d[2] ?? ``)} }` + ` in ` +  d[6]},
    {"name": "case_expression$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "case_expression$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "case_expression$ebnf$1", "symbols": ["block_end"], "postprocess": id},
    {"name": "case_expression$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "case_expression", "symbols": [{"literal":"case"}, "case_expression$subexpression$1", "expression", "case_expression$subexpression$2", {"literal":"of"}, "block_start", "case_arms", "case_expression$ebnf$1"], "postprocess": (d) => `case ${d[2]} of { ${d[6]} }`},
    {"name": "case_arms$ebnf$1", "symbols": []},
    {"name": "case_arms$ebnf$1$subexpression$1$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "case_arm$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "case_arm$subexpression$1", "symbols": ["case_arm$subexpression$1$subexpression$1"]},
    {"name": "case_arm$subexpression$1", "symbols": ["_"]},
    {"name": "case_arm$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "deriving_classes$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", (PreprocessorLexer.has("typeClass") ? {type: "typeClass"} : typeClass)]},
    ...
    {"name": "deriving_classes", "symbols": [(PreprocessorLexer.has("typeClass") ? {type: "typeClass"} : typeClass), "deriving_classes$ebnf$1"], "postprocess": (d) => [d[0].value, ...d[1].map(x => x[3].value)].join(", ")},
    {"name": "constructor_def$ebnf$1$subexpression$1", "symbols": [(PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "constructor_def$ebnf$2$subexpression$1", "symbols": [(PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "constructor_def$ebnf$3$subexpression$1", "symbols": [(PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "constructor_def", "symbols": ["constr", "_", "constructor_def$ebnf$1", (PreprocessorLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "constructor_def$ebnf$2", "field_list", "_", "constructor_def$ebnf$3", (PreprocessorLexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": (d) => d[0] + ` { ` + d[6] + ` }`},
    ...
    {"name": "field_list$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": [(PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    ...
    {"name": "field", "symbols": ["variable", "_", (PreprocessorLexer.has("typeEquals") ? {type: "typeEquals"} : typeEquals), "_", "type"], "postprocess": (d) => d[0] + ` :: ` + d[4]},
    {"name": "binding_name", "symbols": [{"literal":"("}, "_", (PreprocessorLexer.has("op") ? {type: "op"} : op), "_", {"literal":")"}], "postprocess": d => `(${d[2].value})`},
    ...
    {"name": "function_signature$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "function_signature$subexpression$1", "symbols": ["function_signature$subexpression$1$subexpression$1"]},
    {"name": "function_signature", "symbols": ["binding_name", "function_signature$ebnf$1", "_", (PreprocessorLexer.has("typeEquals") ? {type: "typeEquals"} : typeEquals), "function_signature$subexpression$1", "type"], "postprocess": (d) => [`${d[0]} :: ${d[5]}`, ...d[1].map(x => `${x[3]} :: ${d[5]}`)].join("\n")},
    {"name": "function_declaration", "symbols": ["variable", "equation"], "postprocess": (d) => d[0] + d[1]},
    {"name": "function_declaration", "symbols": [{"literal":"("}, "_", (PreprocessorLexer.has("op") ? {type: "op"} : op), "_", {"literal":")"}, "equation"], "postprocess": (d) => `(${d[2]})` + d[5]},
    {"name": "return_expression", "symbols": ["expression"], "postprocess": d => d[0]},
    {"name": "where_clause", "symbols": [{"literal":"where"}, "block_start", "bindings_list", "block_end"], "postprocess": d => `where { ${d[2]} }`},
    ...
    {"name": "bindings_list$ebnf$1$subexpression$1$subexpression$1$subexpression$2$ebnf$1", "symbols": ["indent"], "postprocess": id},
    {"name": "bindings_list$ebnf$1$subexpression$1$subexpression$1$subexpression$2$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "bindings_list$ebnf$1$subexpression$1$subexpression$1$subexpression$2", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "bindings_list$ebnf$1$subexpression$1$subexpression$1$subexpression$2$ebnf$1", "__"]},
    ...
    {"name": "equation$ebnf$1", "symbols": ["equation_where"], "postprocess": id},
    ...
    {"name": "equation$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "indent", "__"]},
    {"name": "equation$ebnf$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    {"name": "equation$ebnf$2", "symbols": ["equation$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "equation$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "equation$subexpression$2$ebnf$1", "symbols": ["equation_where"], "postprocess": id},
    {"name": "equation$subexpression$2$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "equation$subexpression$2", "symbols": ["equation$subexpression$2$ebnf$1"]},
    {"name": "equation$subexpression$2", "symbols": ["dedent"]},
    {"name": "equation", "symbols": ["params", "equation$subexpression$1", "guarded_rhs", "equation$ebnf$2", "equation$subexpression$2"], "postprocess":  (d) => {
          const body = d[2];
          const whereClause = d[3] ? ` ` + d[3] : ``;
          return d[0] + ` ` + body + whereClause;
        } },
    {"name": "equation$ebnf$3", "symbols": ["equation_where"], "postprocess": id},
    {"name": "equation$ebnf$3", "symbols": [], "postprocess": () => null},
    {"name": "equation", "symbols": ["params", (PreprocessorLexer.has("assign") ? {type: "assign"} : assign), "_", "return_expression", "equation$ebnf$3"], "postprocess": d => d[0] + ` = ` + d[3] + (d[4] ? ` ` + d[4] : ``)},
    {"name": "equation$subexpression$3", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "indent", "__"]},
    {"name": "equation$subexpression$4$ebnf$1", "symbols": ["equation_where"], "postprocess": id},
    {"name": "equation$subexpression$4$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "equation$subexpression$4", "symbols": ["equation$subexpression$4$ebnf$1"]},
    {"name": "equation$subexpression$4", "symbols": ["dedent"]},
    {"name": "equation", "symbols": ["params", (PreprocessorLexer.has("assign") ? {type: "assign"} : assign), "equation$subexpression$3", "return_expression", "equation$subexpression$4"], "postprocess": d => d[0] + ` = ` + d[3] + (d[4] ? ` ` + d[4] : ``)},
    {"name": "equation_where$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "equation_where", "symbols": ["equation_where$subexpression$1", "indent", "__", "where_clause", "dedent"], "postprocess": d => d[3]},
    {"name": "equation_where", "symbols": ["where_clause"], "postprocess": d => d[1]},
    {"name": "params", "symbols": ["__", "parameter_list", "_"], "postprocess": d => ` ${d[1]}`},
    {"name": "params", "symbols": ["_"], "postprocess": d => ``},
    {"name": "guarded_rhs$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "indent", "__"]},
    {"name": "guarded_rhs$ebnf$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_"]},
    {"name": "guarded_rhs$ebnf$1", "symbols": ["guarded_rhs$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "guarded_rhs$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "guarded_rhs", "symbols": ["guarded_branch", "guarded_rhs$subexpression$1", "guarded_rhs", "guarded_rhs$ebnf$1", "dedent"], "postprocess": (d) => `${d[0]} ${d[2]}`},
    {"name": "guarded_rhs$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "guarded_rhs$subexpression$2", "symbols": ["guarded_rhs$subexpression$2$subexpression$1"]},
    {"name": "guarded_rhs$subexpression$2", "symbols": ["_"]},
    {"name": "guarded_rhs", "symbols": ["guarded_branch", "guarded_rhs$subexpression$2", "guarded_rhs"], "postprocess": (d) => `${d[0]} ${d[2]}`},
    {"name": "guarded_rhs", "symbols": ["guarded_branch"], "postprocess": (d) => d[0]},
    {"name": "guarded_branch$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "guarded_branch$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "guarded_branch$subexpression$3$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "wildcard_pattern", "symbols": [(PreprocessorLexer.has("anonymousVariable") ? {type: "anonymousVariable"} : anonymousVariable)], "postprocess": (d) => `_`},
    ...
    {"name": "constrained_type", "symbols": ["constraint_list", "_", (PreprocessorLexer.has("arrow") ? {type: "arrow"} : arrow), "_", "type"], "postprocess": (d) => d[0] + ` -> ` + d[4]},
    ...
    {"name": "constraint", "symbols": [(PreprocessorLexer.has("typeClass") ? {type: "typeClass"} : typeClass), "constraint$ebnf$1"], "postprocess": (d) => [d[0].value, ...d[1].map(x => x[1])].join(" ")},
    {"name": "function_type$ebnf$1$subexpression$1", "symbols": ["context", "_", (PreprocessorLexer.has("arrow") ? {type: "arrow"} : arrow), "_"]},
    ...
    {"name": "function_type$ebnf$2$subexpression$1$subexpression$1$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "function_type$ebnf$2$subexpression$1$subexpression$2$subexpression$1", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    ...
    {"name": "function_type$ebnf$2$subexpression$1", "symbols": ["application_type", "function_type$ebnf$2$subexpression$1$subexpression$1", (PreprocessorLexer.has("typeArrow") ? {type: "typeArrow"} : typeArrow), "function_type$ebnf$2$subexpression$1$subexpression$2"]},
    ...
    {"name": "constr", "symbols": [(PreprocessorLexer.has("constructor") ? {type: "constructor"} : constructor)], "postprocess": (d) => `${d[0].value}`},
    {"name": "variable", "symbols": [(PreprocessorLexer.has("variable") ? {type: "variable"} : variable)], "postprocess": (d) => `${d[0].value}`},
    ...
    {"name": "primitive$subexpression$1", "symbols": [(PreprocessorLexer.has("number") ? {type: "number"} : number)]},
    {"name": "primitive$subexpression$1", "symbols": [(PreprocessorLexer.has("char") ? {type: "char"} : char)]},
    {"name": "primitive$subexpression$1", "symbols": [(PreprocessorLexer.has("string") ? {type: "string"} : string)]},
    {"name": "primitive$subexpression$1", "symbols": [(PreprocessorLexer.has("bool") ? {type: "bool"} : bool)]},
    {"name": "primitive", "symbols": ["primitive$subexpression$1"], "postprocess": (d) => `${d[0][0].value}`},
    {"name": "_$ebnf$1", "symbols": []},
    {"name": "_$ebnf$1", "symbols": ["_$ebnf$1", (PreprocessorLexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "_", "symbols": ["_$ebnf$1"]},
    {"name": "__$ebnf$1", "symbols": [(PreprocessorLexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "__$ebnf$1", "symbols": ["__$ebnf$1", (PreprocessorLexer.has("WS") ? {type: "WS"} : WS)], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "__", "symbols": ["__$ebnf$1"]},
    {"name": "indent", "symbols": [(PreprocessorLexer.has("indent") ? {type: "indent"} : indent)], "postprocess": d => ""},
    {"name": "dedent", "symbols": [(PreprocessorLexer.has("dedent") ? {type: "dedent"} : dedent)], "postprocess": d => ""},
    {"name": "block_start", "symbols": ["_", {"literal":"{"}, "_"]},
    {"name": "block_start", "symbols": ["_", "indent", "_"]},
    {"name": "block_start", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "block_start", "symbols": ["_"]},
    {"name": "block_end", "symbols": ["_", {"literal":"}"}, "_"]},
    {"name": "block_end", "symbols": ["_", "dedent", "_"]},
    {"name": "block_end", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "_", "dedent", "_"]},
    {"name": "block_end", "symbols": ["_", (PreprocessorLexer.has("NL") ? {type: "NL"} : NL), "__"]},
    {"name": "block_end", "symbols": ["_"]}
  ],
  ParserStart: "program",
};
