import { APPLY_METHOD, CLOSURE_EVALUATE_METHOD, CLOSURE_TO_STRING_METHOD, COLLECTION_MODULE, DATE_MODULE, KEYWORDS, TO_STRING_METHOD } from '../constants.js'
import { hash, isEmpty, List } from '../extensions.js'
import { assertNotVoid, showParameter } from '../helpers.js'
import { assertIsCollection, assertIsNumber, assertIsString, assertIsNotNull, Evaluation, Execution, Frame, Natives, RuntimeObject, RuntimeValue } from '../interpreter/runtimeModel.js'
import { Class, Node, Singleton } from '../model.js'
